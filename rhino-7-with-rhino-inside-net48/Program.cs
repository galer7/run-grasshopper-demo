...
namespace RunGrasshopperOnRhino7WithRhinoInside
{
  class Program
  {
    static Program()
    ...
    static void RunHelper()
    {
      ...
      using (var resStream = assembly.GetManifestResourceStream("RunGrasshopperOnRhino7WithRhinoInside.simple_def.gh"))
